...
import services3Data from '../../data/cv.json';

const CommercialVisualization = () => {
  React.useEffect(() => {
    ...
    <MainLayout>
      <PageHeader
        ...
        fullPath={[
          ...
          {
            id: 2,
            name: 'commercial visualization',
            url: '/commercial-visualization',
          },
        ]}
...
export default CommercialVisualization;
