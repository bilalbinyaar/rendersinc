...
import services3Data from '../../data/cv4.json';

const InteriorDesignVisualization = () => {
  React.useEffect(() => {
      ...
      <PageHeader
        ...
        fullPath={[
          { id: 1, name: 'home', url: '/' },
          {
            ...
            url: '/interior-design-visualization',
          },
        ]}
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-8 offset-lg-1 col-md-8 mb-30">
              <div className="text">
                <p>
                  Interior Design Visualization brings your interior design
                  concepts to life with precise and stunning visuals. Our
                  advanced technology allows you to see and refine every detail
                  of your design, ensuring your vision is perfectly realized.
                </p>
              </div>
            </div>
          </div>
...
export default InteriorDesignVisualization;
