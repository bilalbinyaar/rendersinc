...
import services3Data from '../../data/cv3.json';

const VirualRealityVisualization = () => {
  React.useEffect(() => {
  ...
  return (
    <MainLayout>
      <PageHeader
        title="Virtual Reality Visualization"
        fullPath={[
          { id: 1, name: 'home', url: '/' },
          {
            id: 2,
            name: 'virtual reality visualization',
            url: '/virtual-reality-visualization',
          },
        ]}
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-8 offset-lg-1 col-md-8 mb-30">
              <div className="text">
                <p>
                  Virtual Reality Visualization takes property exploration to
                  the next level by immersing you in a realistic virtual
                  environment. This advanced technology allows you to experience
                  properties as if you were physically there, providing a
                  comprehensive and engaging way to explore and evaluate spaces.
                </p>
              </div>
            </div>
          </div>
...
export default VirualRealityVisualization;
