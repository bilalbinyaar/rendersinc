...
import services3Data from '../../data/cv1.json';

const ResidentialVisualization = () => {
  React.useEffect(() => {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-8 offset-lg-1 col-md-8 mb-30">
              <div className="text">
                <p>
                  Residential Visualization brings your dream home to life
                  through detailed and immersive visuals. Our advanced
                  technology ensures every aspect of your vision is accurately
                  depicted, allowing you to see and refine your home before
                  construction begins.
                </p>
              </div>
            </div>
...
export default ResidentialVisualization;
